          ...
          <v-col cols="12">
              <v-card
                ...
                <v-card-title>
                    <v-icon
                       large
                       left>mdi-file-download</v-icon>
                    <span class="text-h6 font-weight-light">Download PDF of your Blog</span>
                ...
                <v-card-actions>
                     <v-list-item class="grow">
                        <v-row
                          ...
                          <v-btn
                          @click="generatePdf">
                           <v-icon @click="pdfpop = true" class="mr-1">mdi-download</v-icon>
                           Save PDF
                           </v-btn>
                       </v-row>
                    </v-list-item>
            ...
            <v-col cols="12">
              <v-snackbar
                 v-model="pdfpop">Generating PDF start
                 <template v-slot:action="{ attrs }">
                    <v-btn 
                      color="pink"
                      text
                      v-bind="attrs"
                      @click="pdfpop = false">close Notification</v-btn>
                  </template>
               </v-snackbar>
            </v-col>
      </v-row>
